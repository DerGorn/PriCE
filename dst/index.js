...
const onSettingsClickHandler = () => {
    if (startMenu === null) {
        throw new Error("Clicked on a Button on a screen that doesn't exist. 'settings' Button should only exist on 'startMenu', but that is 'null'.");
    }
...
const createSettingsMenu = () => {
    ...
    const end = createDiv("settings", "icon");
        ...
        if (startMenu === null) {
            throw new Error("Clicked on a Button on a screen that doesn't exist. 'end' Button should only exist on 'settings' a child of 'startMenu', but that is 'null'.");
        }
        settings.remove();
